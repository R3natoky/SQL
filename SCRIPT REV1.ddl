...
( 
	...
	[Apeelido_M]         varchar(20)  NULL ,
	[Categoria]          varchar(20)  NULL ,
	[Nro_Orden]          integer  NULL ,
	[DNI]                int  NULL ,
	[Salario]            float  NULL 
)
go
...
ALTER TABLE [COMPONENTE]
	ADD CONSTRAINT [XPKCOMPONENTE] PRIMARY KEY  CLUSTERED ([Id_Proyecto] ASC,[Id_Componente] ASC)
go

ALTER TABLE [Detalle_Almacen]
	ADD CONSTRAINT [XPKDetalle_Almacen] PRIMARY KEY  CLUSTERED ([Id_Nota] ASC,[Id_Material] ASC)
go

ALTER TABLE [Detalle_Parte]
	ADD CONSTRAINT [XPKDetalle_Parte] PRIMARY KEY  CLUSTERED ([Id_Parte] ASC,[Id_Equipo] ASC)
go

ALTER TABLE [Detalle_Tareo]
	ADD CONSTRAINT [XPKDetalle_Tareo] PRIMARY KEY  CLUSTERED ([Id_Tareo] ASC,[Id_Personal] ASC)
go

ALTER TABLE [ENTREGABLE]
	ADD CONSTRAINT [XPKENTREGABLE] PRIMARY KEY  CLUSTERED ([Id_Componente] ASC,[Id_Entregable] ASC)
go
...
ALTER TABLE [NOTA_ALMACEN]
	ADD CONSTRAINT [XPKNOTA_ALMACEN] PRIMARY KEY  CLUSTERED ([Id_Nota] ASC,[Id_Partida] ASC)
go

ALTER TABLE [PARTE_EQUIPOS]
	ADD CONSTRAINT [XPKPARTE_EQUIPOS] PRIMARY KEY  CLUSTERED ([Id_Parte] ASC,[Id_Equipo] ASC,[Id_Partida] ASC)
go

ALTER TABLE [PARTIDA]
	ADD CONSTRAINT [XPKPARTIDA] PRIMARY KEY  CLUSTERED ([Id_Entregable] ASC,[Id_Partida] ASC)
go
...
ALTER TABLE [PROYECTO]
	ADD CONSTRAINT [XPKPROYECTO] PRIMARY KEY  CLUSTERED ([Id_Proyecto] ASC,[Id_Cliente] ASC,[UBIGEO] ASC)
go

ALTER TABLE [TAREO_MO]
	ADD CONSTRAINT [XPKTAREO_MO] PRIMARY KEY  CLUSTERED ([Id_Tareo] ASC,[Id_Entregable] ASC,[Id_Partida] ASC)
go
...
ALTER TABLE [COMPONENTE]
	ADD CONSTRAINT [R_1] FOREIGN KEY ([Id_Proyecto],[Id_Cliente],[UBIGEO]) REFERENCES [PROYECTO]([Id_Proyecto],[Id_Cliente],[UBIGEO])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [Detalle_Almacen]
	ADD CONSTRAINT [R_15] FOREIGN KEY ([Id_Nota],[Id_Partida]) REFERENCES [NOTA_ALMACEN]([Id_Nota],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [Detalle_Parte]
	ADD CONSTRAINT [R_22] FOREIGN KEY ([Id_Parte],[Id_Equipo],[Id_Partida]) REFERENCES [PARTE_EQUIPOS]([Id_Parte],[Id_Equipo],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [Detalle_Tareo]
	ADD CONSTRAINT [R_24] FOREIGN KEY ([Id_Tareo],[Id_Entregable],[Id_Partida]) REFERENCES [TAREO_MO]([Id_Tareo],[Id_Entregable],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [ENTREGABLE]
	ADD CONSTRAINT [R_3] FOREIGN KEY ([Id_Proyecto],[Id_Componente]) REFERENCES [COMPONENTE]([Id_Proyecto],[Id_Componente])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [NOTA_ALMACEN]
	ADD CONSTRAINT [R_27] FOREIGN KEY ([Id_Entregable],[Id_Partida]) REFERENCES [PARTIDA]([Id_Entregable],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [PARTE_EQUIPOS]
	ADD CONSTRAINT [R_20] FOREIGN KEY ([Id_Equipo]) REFERENCES [EQUIPO]([Id_Equipo])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go

ALTER TABLE [PARTE_EQUIPOS]
	ADD CONSTRAINT [R_21] FOREIGN KEY ([Id_Entregable],[Id_Partida]) REFERENCES [PARTIDA]([Id_Entregable],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [PARTIDA]
	ADD CONSTRAINT [R_4] FOREIGN KEY ([Id_Componente],[Id_Entregable]) REFERENCES [ENTREGABLE]([Id_Componente],[Id_Entregable])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [TAREO_MO]
	ADD CONSTRAINT [R_8] FOREIGN KEY ([Id_Entregable],[Id_Partida]) REFERENCES [PARTIDA]([Id_Entregable],[Id_Partida])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
