...
ALTER TABLE [UBIGEO]
	ADD CONSTRAINT [XPKUBICACION] PRIMARY KEY  CLUSTERED ([ID_UBIGEO] ASC)
go
...
ALTER TABLE [PROYECTO]
	ADD CONSTRAINT [R_19] FOREIGN KEY ([UBIGEO]) REFERENCES [UBIGEO]([ID_UBIGEO])
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE [PARTE_EQUIPOS]
	ADD CONSTRAINT [R_PARTE_PARTIDA]
...
ALTER TABLE [Detalle_Parte]
	ADD CONSTRAINT [R_PARTE_DETALLE]
